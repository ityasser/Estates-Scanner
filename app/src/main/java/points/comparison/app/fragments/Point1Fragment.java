 ...
 */
public class Point1Fragment extends Fragment {
    ...
    private void requestGetgetRegion(String lat,String lng) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ProgressDialog.hide();
                Log.d("Region1", response);

                Point2Fragment point1Fragment = new Point2Fragment();

                Bundle bundle =new Bundle();
                bundle.putString("region1",response.trim());
